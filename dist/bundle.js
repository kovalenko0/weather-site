...
var AppView = (function (_super) {
    ...
    AppView.prototype.componentWillReceiveProps = function (props) {
    ...
    AppView.prototype.render = function () {
        return React.createElement("div", null,
            React.createElement("h1", null, "App View"),
            React.createElement("div", null,
                "City: ",
                this.state.city),
            React.createElement("div", null,
                "Period: ",
                this.state.forecastPeriod));
    };
    return AppView;
}(React.Component));
...
var weather_client_1 = __webpack_require__(20);
var AppModel = (function () {
    function AppModel() {
        this.weatherClient = new weather_client_1.WeatherClient();
        this.store = store_1.createAppStore({});
        this.updateLocation();
    }
    AppModel.prototype.subscribe = function (view) {
        var _this = this;
        return this.store.subscribe(function () { return view.setState(_this.store.getState()); });
    };
    AppModel.prototype.updateLocation = function () {
        var _this = this;
...
var app_view_1 = __webpack_require__(15);
var model_1 = __webpack_require__(16);
ReactDOM.render(React.createElement(app_view_1.AppView, { model: new model_1.AppModel() }), document.getElementById("app"));
...
var ActionType;
(function (ActionType) {
    ActionType[ActionType["SetCity"] = 0] = "SetCity";
    ActionType[ActionType["SetForecastPeriod"] = 1] = "SetForecastPeriod";
})(ActionType = exports.ActionType || (exports.ActionType = {}));
function createAppStore(initialState) {
    return redux_1.createStore(mainReducer);
}
...
function mainReducer(state, action) {
    switch (action.type) {
        ...
        case ActionType.SetForecastPeriod:
            return setForecastPeriod(state, action.payload);
        default:
            return state;
    }
}
function setCity(state, city) {
    return __assign({}, state, { city: city });
}
function setForecastPeriod(state, forecastPeriod) {
    return __assign({}, state, { forecastPeriod: forecastPeriod });
}
...
var WeatherClient = (function () {
    ...
    WeatherClient.prototype.getForecast = function (lat, lon) {
        return axios_1.default.get('http://api.openweathermap.org/data/2.5/weather', {
            params: {
                lat: lat,
                lon: lon,
